...
class Admin::ServiceInterestsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     ServiceInterest: create, read, update, destroy, custom_action
  #
  #   editor:
  #     ServiceInterest: create, read, update, custom_action_for_an_item
  #
