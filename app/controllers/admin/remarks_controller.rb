...
class Admin::RemarksController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Remark: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Remark: create, read, update, custom_action_for_an_item
  #
