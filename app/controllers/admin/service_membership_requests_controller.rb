...
class Admin::ServiceMembershipRequestsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     ServiceMembershipRequest: create, read, update, destroy, custom_action
  #
  #   editor:
  #     ServiceMembershipRequest: create, read, update, custom_action_for_an_item
  #
