...
class Admin::ServiceMembershipsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     ServiceMembership: create, read, update, destroy, custom_action
  #
  #   editor:
  #     ServiceMembership: create, read, update, custom_action_for_an_item
  #
