...
class Admin::ActivitiesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Activity: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Activity: create, read, update, custom_action_for_an_item
  #
