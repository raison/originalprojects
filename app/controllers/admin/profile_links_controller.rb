...
class Admin::ProfileLinksController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     ProfileLink: create, read, update, destroy, custom_action
  #
  #   editor:
  #     ProfileLink: create, read, update, custom_action_for_an_item
  #
