...
class Admin::MembershipRequestsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     MembershipRequest: create, read, update, destroy, custom_action
  #
  #   editor:
  #     MembershipRequest: create, read, update, custom_action_for_an_item
  #
