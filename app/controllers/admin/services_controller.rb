...
class Admin::ServicesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Service: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Service: create, read, update, custom_action_for_an_item
  #
